...
For a non-isolated installation (i.e. you want ratel-local to take over your real Claude Code MCP setup, not a sandboxed `--mcp-config` session), use the `ratel import` wizard instead of this template.
