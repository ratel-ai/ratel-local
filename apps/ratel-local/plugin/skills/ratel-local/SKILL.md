...
The plugin `.mcp.json` runs `npx -y @ratel-ai/ratel-local@0.5.0-rc.0 connect`.
...
2. Confirm the plugin `.mcp.json` starts `@ratel-ai/ratel-local@0.5.0-rc.0` with `connect`.
